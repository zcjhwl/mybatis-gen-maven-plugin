...
English | [简体中文](https://github.com/zcjhwl/mybatis-generator-bestpractice/blob/master/Readme-CN.md)<br>
...
## How to use
Step 1: Make sure your project is a maven project, add the mybatis-gen-maven-plugin to your maven pom.xml file:<br>
```
<plugin>
